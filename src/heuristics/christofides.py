...
class Christofides:
    ...
    def __init__(self, dist_matrix, timeout=None, tracking=False):
        '''
        ...
        data = self.create_data_model(dist_matrix)
    ...
    def create_data_model(self, dist_matrix):
    ...
    def total_cost(self, dist_matrix, route):
        cost = 0.0
...
def print_solution(dist_matrix, manager, routing, solution):
    ...
    print("Route: ", route)
    print("A Solution was found\nObjective value: ", self.total_cost(dist_matrix, route))
